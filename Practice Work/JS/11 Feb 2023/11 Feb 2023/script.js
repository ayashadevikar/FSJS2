...
const miniTemp1 = document.getElementById("minTemp1");
...
const getData = async (event) => {
  ...
  const fetchData = await fetch(
    ...
    `http://api.weatherapi.com/v1/forecast.json?key=62573e1ec4e84bdfbbb73254231602&q=${city}&days=14`
  ...
  const moredays = function days(days) {
